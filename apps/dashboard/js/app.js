...
const firebaseConfig = {
  apiKey: "AIzaSyC325d6C-r6iHAVIbd6ld4W4krDuhIvkLk",
  authDomain: "smsos-7e95c.firebaseapp.com",
  projectId: "smsos-7e95c",
  storageBucket: "smsos-7e95c.firebasestorage.app",
  messagingSenderId: "947281731067",
  appId: "1:947281731067:web:712c05d5bad93ed2f53f5e"
};
...
async function handleGoogleSignIn() {
  ...
  const buttons = [loginBtn, signupBtn].filter(b => b !== null);
  ...
  try {
    ...
    if (data.needs_onboarding) {
      ...
      showToast('Welcome! Please complete your shop setup.');
    ...
    buttons.forEach(btn => {
      btn.disabled = false;
      const isSignup = btn.id === 'google-signup-btn';
      const labelText = isSignup ? 'Sign up with Google' : 'Sign in with Google';
      btn.innerHTML = `<svg viewBox="0 0 24 24" width="20" height="20" style="flex-shrink:0;">
